...
GroupAdd "windowsVim", "ahk_class ConsoleWindowClass" ; conhost (cmd / PowerShell / WSL Ubuntu)
GroupAdd "IgnoreApplications", "ahk_class CASCADIA_HOSTING_WINDOW_CLASS" ; Windows Terminal
GroupAdd "IgnoreApplications", "ahk_class ConsoleWindowClass" ; conhost (cmd / PowerShell / WSL Ubuntu)
